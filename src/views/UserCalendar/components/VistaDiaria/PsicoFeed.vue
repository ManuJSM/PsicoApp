<template>
  <div
    class="bg-card-dark rounded-2xl p-6 flex flex-col gap-4 border border-border-dark shadow-2xl transition-all duration-300 md:h-full md:min-h-[300px]"
    :class="
      hasFeedback
  ...
  >
    <div class="flex-none flex items-center gap-4">
      <div class="relative shrink-0">
        <div
          class="size-10 rounded-2xl border p-0.5 transition-colors duration-500"
          :class="
            hasFeedback
    ...
    <div class="flex-1 md:relative min-h-0">
      <div
        class="flex flex-col px-4 py-1 rounded-2xl transition-all duration-300 md:absolute md:inset-0"
        :class="
          hasFeedback
